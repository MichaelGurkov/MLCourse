...
boosting_explainer = explain(boost_model, data = select(train_set, -target),
                        y = train_set$target)

bagging_explainer = explain(bag_model, data = select(train_set, -target),
                        y = train_set$target)

rf_explainer = explain(rf_model, data = select(train_set, -target),
                        y = train_set$target)

knn_explainer = explain(knn_model, data = select(train_set, -target),
                        y = train_set$target)
...
plot(model_performance(boosting_explainer))

plot(model_performance(bagging_explainer))

plot(model_performance(knn_explainer))
...
plot(variable_importance(boosting_explainer))

plot(variable_importance(bagging_explainer))

plot(variable_importance(knn_explainer))

plot(variable_importance(rf_explainer))

```

```{r model_profile}

plot(model_profile(boosting_explainer))

plot(model_profile(bagging_explainer))

plot(model_profile(knn_explainer))

plot(model_profile(rf_explainer))
...
plot(predict_parts_break_down(knn_explainer, slice(train_set,1)))

plot(predict_parts_break_down(rf_explainer, slice(train_set,1)))

plot(predict_parts_break_down(bagging_explainer, slice(train_set,1)))

plot(predict_parts_break_down(boosting_explainer, slice(train_set,1)))
...
predict(knn_model, test_set)

predict(rf_model, test_set)

predict(bag_model, test_set)

predict(boost_model, test_set)
